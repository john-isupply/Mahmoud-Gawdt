...
async function fetchSheetData() {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbxKVEZMDv1BbLCefsmhHyav6HV88bp4L5kPY5pVE7nI6Bf5CW5igHzsXnmobZrrfDK_/exec');
...
function sendLink() {
    ...
    const fixedNumber = document.getElementById('fixed-whatsapp-link').dataset.fixedNumber || "+201103082260"; // Default to Ahmed's number
...
function openGoogleSheet() {
    window.open('https://docs.google.com/spreadsheets/d/1eNdqVGF18ochVtyhVJpPyoVTD0ycUki4MIGtngd7-gc/edit?gid=1996448202#gid=1996448202', '_blank');
}
